...
// Build version (set by build flags)
var version = "dev"
...
func main() {
	...
	if *help {
		fmt.Printf("Civitai API Tester v%s\n", version)
		fmt.Println("==========================")
	...
	fmt.Printf("Civitai API Tester v%s - Starting server...\n", version)
...
func runAllTests() {
	...
	testSuite.Summary.Passed = 0 // Reset passed count
	testSuite.Summary.Failed = 0 // Reset failed count
